...
make[2]: 进入目录“/root/tools/mysql-audit/pcre”
CDPATH="${ZSH_VERSION+.}:" && cd . && /bin/sh /root/tools/mysql-audit/pcre/missing aclocal-1.15 -I m4
/root/tools/mysql-audit/pcre/missing:行81: aclocal-1.15: 未找到命令
...
来自 <https://stackoverflow.com/questions/64141078/compile-c-file-in-linux-terminal-string-view-no-such-file-or-directory> 
...
Download https://github.com/madler/zlib/releases
tar …
cd …
./configure
make 
